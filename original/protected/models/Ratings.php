...
class Ratings extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('application_id, user_id, rating, date_rated', 'required'),
			array('application_id, user_id', 'numerical', 'integerOnly'=>true),
			array('rating', 'length', 'max'=>1),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, application_id, user_id, rating, date_rated', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('date_rated',$this->date_rated,true);
